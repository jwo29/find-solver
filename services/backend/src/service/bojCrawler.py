...
from src.service.chromeVersionCheck import installChromeDriver
...
# Chrome driver path 설정

def member_crawler():

    # Set chrome driver
    driver_path = installChromeDriver()
    ...
    try:
        ...
        with open('./data/member-db.json', 'r', encoding='utf-8') as f:
            ...
            for member in member_db['members']:
                ...
                logger.debug(f'member {member_id} 크롤링 시작')
